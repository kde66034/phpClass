                    ...
                    <fieldset>
                        ...
                        <div class="join__box">
                            ...
                            <div class="overlap">
                                ...
                                <p class="msg" id="youNickNameComment"><!-- * 이미 닉네임이 존재합니다. --></p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p class="msg" id="youBirthComment"><!-- * 올바른 생년월일을 입력해주세요. --></p>
                            </div>
                            <div>
                                <label for="youPhone">휴대폰번호</label>
                                <input type="text" id="youPhone" name="youPhone" placeholder="010-0000-0000" maxlength="15" autocomplete="off" required>
                                <p class="msg" id="youPhoneComment"><!-- * 올바른 휴대폰 번호를 입력해주세요. --></p>
                            </div>
                        </div>
